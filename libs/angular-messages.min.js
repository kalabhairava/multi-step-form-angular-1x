...
(function(z, h, A) {
						...
						g.register(
							...
							(q = {
								test: function(b) {
									var a = p;
									b = a
										? v(a) ? 0 <= a.indexOf(b) : a.hasOwnProperty(b)
										: void 0;
									return b;
								},
								attach: function() {
	...
	h
						...
						function(f, a, g) {
							function l(b, a) {
								for (var d = a, f = []; d && d !== b; ) {
									...
									d.childNodes.length && -1 == f.indexOf(d)
										? (f.push(d), (d = d.childNodes[d.childNodes.length - 1]))
										: (d = d.previousSibling || d.parentNode);
								}
							}
							var c = this,
								p = 0,
							...
							this.render = function(b) {
								...
								q = b;
								for (
									var p = r(a, g.ngMessagesMultiple) || r(a, g.multiple),
										d = [],
										k = {},
										s = c.head,
										l = !1,
								...
								d.length !== m
									? h.setClass(f, 'ng-active', 'ng-inactive')
									: h.setClass(f, 'ng-inactive', 'ng-active');
							};
							...
							this.register = function(b, a) {
								...
								c.head
									? (e = l(e, b))
										? ((g.next = e.next), (e.next = g))
										: ((g.next = c.head), (c.head = g))
									: (c.head = g);
								b.$$ngMessageNode = d;
								p++;
								c.reRender();
		...
		.directive('ngMessage', m('AE'))
		.directive('ngMessageExp', m('A'));
